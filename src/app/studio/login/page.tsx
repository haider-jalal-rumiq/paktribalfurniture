    ...
    <div className="min-h-screen pb-20 pt-32 sm:pt-40">
      <Container className="max-w-xl">
        <div className="border border-hairline bg-surface p-7 sm:p-10">
          ...
          {!configured ? <p role="alert" className="mt-7 border border-accent/30 bg-accent/8 p-4 text-sm leading-6 text-accent-deep">Supabase environment variables are not configured. Follow the setup guide in the project README before signing in.</p> : <AdminLoginForm redirectTo="/studio" />}
