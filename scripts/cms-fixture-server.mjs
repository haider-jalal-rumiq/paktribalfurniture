...
export function cmsFixture() {
  ...
  const db = {
    ...
    labour_entries: [{ id: id(), name: "QA Worker", period: "2026-09-01", paid_on: "2026-09-09", salary: 40000, total_amount: 38000, advance: 10000, salary_paid: 5000, leaves: 2, notes: "Agreed adjustment", created_at: stamp, updated_at: stamp }],
    invoices: [invoice, { ...invoice, id: id(), invoice_no: 2, issued_on: "2026-09-26", items: [{ ...invoice.items[0], quantity: 1, amount: 22000 }], total_amount: 22000 }, { ...invoice, id: id(), invoice_no: 3, client_id: school.id, client_name: school.name, issued_on: "2026-09-27", items: [{ ...invoice.items[0], quantity: 1, amount: 500 }], total_amount: 500 }], products: [],
  };
